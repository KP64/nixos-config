...
{
  den.aspects.mahdi = {
    den = [ den.aspects.secrets._.oauth ];
          ...
          services.karakeep = {
            ...
            extraEnvironment =
              ...
              in
              {
                ...
                OAUTH_WELLKNOWN_URL = "${toplevel.config.flake.nixosConfigurations.sheherazade.config.services.kanidm.server.settings.origin}/oauth2/openid/${OAUTH_CLIENT_ID}/.well-known/openid-configuration";
